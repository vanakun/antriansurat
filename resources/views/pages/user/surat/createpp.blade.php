...
@section('content')
    ...
    <div class="flex overflow-hidden">
        ...
        <div class="content">
            ...
            <div class="px-6 py-4">
                <h2 class="text-xl font-semibold mb-4">Form PENANGANAN PELANGGARAN DAN SENGKETA PEMILU</h2>

                <form action="{{ route('storesuratpp') }}" method="POST" class="max-w-md">
                    ...
                    <div class="mb-4">
                        ...
                        <datalist id="substantifOptions">
                            <option value="PP.00.00">Penanganan temuan pelanggaran Tingkat Pusat</option>
                            <option value="PP.00.01">Penanganan temuan pelanggaran Tingkat Provinsi</option>
                            <option value="PP.00.02">Penanganan temuan Tingkat Kabupaten/Kota</option>
                            
                            <option value="PP.01.00">Penanganan laporan/pengaduan pelanggaran Pemilu Tingkat Pusat</option>
                            <option value="PP.01.01">Penanganan laporan/pengaduan pelanggaran Tingkat Provinsi</option>
                            <option value="PP.01.02">Penanganan laporan/pengaduan pelanggaran Tingkat Kabupaten/Kota</option>
                        
                            <option value="PP.02">Laporan Pelanggaran Pemilu Yang Tidak Diregistrasi</option>
