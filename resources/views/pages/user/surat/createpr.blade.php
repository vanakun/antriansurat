...
@section('content')
    ...
    <div class="flex overflow-hidden">
        ...
        <div class="content">
            ...
            <div class="px-6 py-4">
                <h2 class="text-xl font-semibold mb-4">Form PERENCANAAN</h2>

                <form action="{{ route('storesuratpr') }}" method="POST" class="max-w-md">
        ...
        <!-- Options for AC -->
                    ...
                    <div class="mb-4">
                        ...
                        <datalist id="fasilitatifOptions">
                            <option value="PR.00.00">Rencana Pembangunan Jangka Panjang (RPJP)</option>
                            <option value="PR.00.01">Rencana Pembangunan Jangka Menengah (RPJM)</option>
                            <option value="PR.00.02">Rencana Strategis (Renstra)</option>

                            <option value="PR.01.00">Usulan Rencana Kegiatan</option>
                            <option value="PR.01.01">Rencana Kerja Tahunan </option>
                            <option value="PR.01.02">Rencana Kerja Tahunan Badan Pengawas Pemilihan Umum</option>

                            <option value="PR.02">Penetapan Kinerja </option>

                            <option value="PR.03.00">Penyusunan Rencana Anggaran</option>
                            <option value="PR.03.01">Revisi Dokumen Anggaran</option>
                            
                            <option value="PR.04.00">Laporan Berkala</option>
                            <option value="PR.04.01">Laporan Khusus</option>
                            <option value="PR.04.02">Laporan Perkembangan/Progress Report</option>
                            <option value="PR.04.03">Laporan Akuntabilitas Kinerja Instansi Pemerintah (LAKIP)</option>
                            <option value="PR.04.04">Evaluasi Program</option>
