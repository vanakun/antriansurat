...
@section('content')
    ...
    <div class="flex overflow-hidden">
        ...
        <div class="content">
            ...
            <div class="px-6 py-4">
                <h2 class="text-xl font-semibold mb-4">Form HUBUNGAN MASYARAKAT (HM)</h2>

                <form action="{{ route('storesurathm') }}" method="POST" class="max-w-md">
...
<div class="mb-4">
                        ...
                        <datalist id="fasilitatifOptions">
                            <option value="HM.00">Analisa Kebutuhan </option>
                            <option value="HM.01">Tata Ruang  </option>
                            <option value="HM.02">Daftar Perkenalan Mampu </option>

                            <option value="HM.03.00">Alat Tulis Kantor</option>
                            <option value="HM.03.01">Perlengkapan Kantor</option>
                            <option value="HM.03.02">Tanah dan Bangunan</option>
                            <option value="HM.03.03">Kendaraan</option>
                            <option value="HM.03.04">Instalasi/ Jaringan </option>
                            <option value="HM.03.05">Peralatan Kearsipan</option>

                            <option value="HM.04">Pemanfaatan Barang </option>
                            <option value="HM.05">Penyimpanan dan distribusi </option>
                            <option value="HM.06">Pemeliharaan </option>
                            <option value="HM.07">Inventarisasi </option>
                            <option value="HM.08">Penghapusan </option>
                            <option value="HM.09">Dokumen Aset </option>
