...
@section('content')
    ...
    <div class="flex overflow-hidden">
        ...
        <h2 class="intro-y text-lg font-medium mt-10">Penanganan Pelangaran dan Sengketa Pemilu (PP)</h2>
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <div class="col-span-12">
                    ...
                    <select id="substantif" name="substantif" class="form-select" required readonly>
                        ...
                        <option value="PP.00.00" {{ ($surat->substantif == 'PP.00.00') ? 'selected' : '' }}>Penanganan temuan pelanggaran Tingkat Pusat</option>
                        <option value="PP.00.01" {{ ($surat->substantif == 'PP.00.01') ? 'selected' : '' }}>Penanganan temuan pelanggaran Tingkat Provinsi</option>
                        <option value="PP.00.02" {{ ($surat->substantif == 'PP.00.02') ? 'selected' : '' }}>Penanganan temuan Tingkat Kabupaten/Kota</option>
                        <option value="PP.01.00" {{ ($surat->substantif == 'PP.01.00') ? 'selected' : '' }}>Penanganan laporan/pengaduan pelanggaran Pemilu Tingkat Pusat</option>
                        <option value="PP.01.01" {{ ($surat->substantif == 'PP.01.01') ? 'selected' : '' }}>Penanganan laporan/pengaduan pelanggaran Tingkat Provinsi</option>
                        <option value="PP.01.02" {{ ($surat->substantif == 'PP.01.02') ? 'selected' : '' }}>Penanganan laporan/pengaduan pelanggaran Tingkat Kabupaten/Kota</option>
                        <option value="PP.02" {{ ($surat->substantif == 'PP.02') ? 'selected' : '' }}>Laporan Pelanggaran Pemilu Yang Tidak Diregistrasi</option>
                    </select>
                </div>
