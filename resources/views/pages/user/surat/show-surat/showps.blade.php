...
@section('content')
    ...
    <div class="flex overflow-hidden">
        ...
        <h2 class="intro-y text-lg font-medium mt-10">PENYELESAIAN SENGKETA (PS)</h2>
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <div class="col-span-12">
                    ...
                    <select id="substantif" name="substantif" class="form-select" required readonly>
                        ...
                        <option value="PS.00.00" {{ ($surat->substantif == 'PS.00.00') ? 'selected' : '' }}>Penyelesaian Sengketa Pemilu Tingkat Pusat</option>
                        <option value="PS.00.01" {{ ($surat->substantif == 'PS.00.01') ? 'selected' : '' }}>Penyelesaian Sengketa Pemilu Tingkat Provinsi</option>
                        <option value="PS.00.02" {{ ($surat->substantif == 'PS.00.02') ? 'selected' : '' }}>Penyelesaian Sengketa Pemilu Tingkat Kabupaten/Kota</option>
                        <option value="PS.00.03" {{ ($surat->substantif == 'PS.00.03') ? 'selected' : '' }}>Penyelesaian Sengketa Pemilu Tingkat Kecamatan</option>
                        
                        <option value="PS.01.00" {{ ($surat->substantif == 'PS.01.00') ? 'selected' : '' }}>Penyelesaian Sengketa Pemilihan Tingkat Pusat</option>
                        <option value="PS.01.01" {{ ($surat->substantif == 'PS.01.01') ? 'selected' : '' }}>Penyelesaian Sengketa Pemilihan Tingkat Provinsi</option>
                        <option value="PS.01.02" {{ ($surat->substantif == 'PS.01.02') ? 'selected' : '' }}>Penyelesaian Sengketa Pemilihan Tingkat Kabupaten/Kota</option>
                        <option value="PS.01.03" {{ ($surat->substantif == 'PS.01.03') ? 'selected' : '' }}>Penyelesaian Sengketa Pemilihan Tingkat Kecamatan</option>
                        
                        <option value="PS.02" {{ ($surat->substantif == 'PS.02') ? 'selected' : '' }}>Sosialisasi Penyelesaian Sengketa</option>
                        <option value="PS.03" {{ ($surat->substantif == 'PS.03') ? 'selected' : '' }}>Pendampingan, Monitoring, dan Evaluasi</option>
                    </select>
                </div>
