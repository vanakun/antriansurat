...
@section('content')
    ...
    <div class="flex overflow-hidden">
        ...
        <div class="content">
            ...
            <div class="px-6 py-4">
                <h2 class="text-xl font-semibold mb-4">Form PERSURATAN DAN KEARSIPAN (KA)</h2>

                <form action="{{ route('storesuratka') }}" method="POST" class="max-w-md">
...
<div class="mb-4">
                        ...
                        <datalist id="fasilitatifOptions">
                            <option value="KA.00">Administrasi Persuratan </option>
                            <option value="KA.01.00">Pembinaan Kearsipan </option>
                            <option value="KA.01.01">Penyusunan Sistem Kearsipan </option>
                            <option value="KA.01.02">Pemeliharaan dan Penyimpanan Arsip </option>
                            <option value="KA.01.03">Penggunaan Arsip </option>
                            <option value="KA.01.04">Penyusutan Arsip </option>

                            <option value="KA.02">Rapat/ Rakor/ Rakernis </option>
