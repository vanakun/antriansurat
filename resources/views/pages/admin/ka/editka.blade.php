...
@section('subcontent')
    ...
    <!-- Content -->
    <div class="content">
        <h2 class="intro-y text-lg font-medium mt-10">Approve SURAT PERSURATAN DAN KEARSIPAN (KA)</h2>
        
        <!-- Form untuk mengunggah surat -->
        <form action="{{ route('updatesuratka', ['id' => $suratka->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
