...
@section('subcontent')
    ...
    <!-- Content -->
    <div class="content">
        <h2 class="intro-y text-lg font-medium mt-10">Approve Antrian SURAT TEKNOLOGI INFORMASI (TI)</h2>
        
        <!-- Form untuk mengunggah surat -->
        <form action="{{ route('updatesuratti', ['id' => $suratti->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
