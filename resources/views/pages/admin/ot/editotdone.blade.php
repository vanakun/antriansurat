...
@section('subcontent')
    ...
    <!-- Content -->
    <div class="content">
        <h2 class="intro-y text-lg font-medium mt-10">Upload SURAT ORGANISASI DAN TATA LAKSANA (OT)</h2>
        
        <!-- Form untuk mengunggah surat -->
        <form action="{{ route('updateotdone', ['id' => $suratot->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
