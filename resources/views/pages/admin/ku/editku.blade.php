...
@section('subcontent')
    ...
    <!-- Content -->
    <div class="content">
        <h2 class="intro-y text-lg font-medium mt-10">Approve SURAT KEUANGAN (KU)</h2>
        
        <!-- Form untuk mengunggah surat -->
        <form action="{{ route('updatesuratku', ['id' => $suratku->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
