...
@section('subcontent')
    ...
    <!-- Content -->
    <div class="content">
        <h2 class="intro-y text-lg font-medium mt-10">Upload SURAT KETATAUSAHAAN DAN KERUMAHTANGGAAN (RT)</h2>
        
        <!-- Form untuk mengunggah surat -->
        <form action="{{ route('updatertdone', ['id' => $suratrt->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
