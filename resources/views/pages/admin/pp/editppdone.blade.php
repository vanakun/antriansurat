...
@section('subcontent')
    ...
    <!-- Content -->
    <div class="content">
        <h2 class="intro-y text-lg font-medium mt-10">Upload Surat PENANGANAN PELANGGARAN DAN SENGKETA PEMILU (PP)</h2>
        
        <!-- Form untuk mengunggah surat -->
        <form action="{{ route('updateppdone', ['id' => $suratpp->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
