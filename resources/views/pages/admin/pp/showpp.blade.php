...
@section('subcontent')
    <div class="flex overflow-hidden">
        <!-- BEGIN: Content -->
        <div class="content">
        <h2 class="intro-y text-lg font-medium mt-10">Antrian SURAT PENANGANAN PELANGGARAN DAN SENGKETA PEMILU (PP)</h2>
            <div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                            @foreach($suratppqueue as $surat)
                            <tr class="intro-x image-fit zoom-in">
                                <td>
                                <a href="{{ route('editsuratpp', ['id' => $surat->id]) }}">
                ...
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                            ...
                            <tr class="intro-x image-fit zoom-in">
                                <td>
                                <a href="{{ route('editsuratppdone', ['id' => $surat->id]) }}">
                                        <div class="font-medium whitespace-nowrap">{{ $surat->id }}</div>
                                    </a>
                                </td>
                                <!-- Other columns -->
