...
@section('subcontent')
    ...
    <!-- Content -->
    <div class="content">
        <h2 class="intro-y text-lg font-medium mt-10">Upload SURAT PERLENGKAPAN (PL)</h2>
        
        <!-- Form untuk mengunggah surat -->
        <form action="{{ route('updatepldone', ['id' => $suratpl->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
