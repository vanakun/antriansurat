...
@section('subcontent')
    ...
    <!-- Content -->
    <div class="content">
        <h2 class="intro-y text-lg font-medium mt-10">Approve Surat PENANGANAN PELANGGARAN DAN SENGKETA PEMILU (PR)</h2>
        
        <!-- Form untuk mengunggah surat -->
        <form action="{{ route('updatesuratpr', ['id' => $suratpr->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
