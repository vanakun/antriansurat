...
class CreateSuratHubunganmasyarakatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('surat_hubungan_masyarakats', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('surat_hubungan_masyarakats');
    }
}
